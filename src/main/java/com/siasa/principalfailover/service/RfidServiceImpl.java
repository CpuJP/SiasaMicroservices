...
public class RfidServiceImpl implements RfidService{
    ...
    @Override
    @Cacheable(value = "rfid-failover", key = "'findAll'")
    ...
    @Override
    @Cacheable(value = "rfid-failover", key = "'findAllP' + #pageNumber + #pageSize")
    ...
    @Override
    @Cacheable(value = "rfid-failover", key = "'findRfidWithoutCodigoU'")
    ...
    @Override
    @Cacheable(value = "rfid-failover", key = "'findById' + #id")
    ...
    @Override
    @CacheEvict(value = "rfid-failover", allEntries = true)
